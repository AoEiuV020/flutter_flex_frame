...
> 这啥啊， 主题又是service又是store到底用什么不能定一下吗， 现在mobx生成代码都失败了， 

> 切换标签的动画不对劲， 按理说标签本身应该不动的， 现在是整个页面都有移动效果， 很奇怪吧，

> 现在这种切换动画好丑， 主要是旧的没走，新的就来了，有一段时间是重叠的，

> 你又给我瞎改， 列表item的国际化又改坏了， 你都不看看吗？别乱用参数化，

> 我刚发现， 项目两个字你压根没有国际化， 你是不行吗？

> 你别给我来回瞎改， 我都说了这样乱用参数化不行了， 你又给我改回来， 

> 你脑残吗，在国际化资源里写死20个项目20个item，你用脚指头想想这合理吗？

> 你就非要用这该死的参数化吗，那里来的%s啊，这里压根没有这种写法， 要么带参数名要么不带参数名， 你改傻了吗？

> 你怎么就这几种错误的写法来回改， 非要我说你吗， 资源里定义带了参数名，使用时又不给参数名， 不觉得奇怪吗？还是你数据库里记的api有问题？

> 还是切换动画，旧页面突然消失太突兀了，就不能淡出吗？

> 没有效果， 标签页切换还是一样旧页面突然消失，

> 还有报错你不管了啊， AdaptiveNavigationScaffold

> 完全没变，你真的知道怎样做能作用到标签页切换吗？不行就直说，

> 还是没有淡出，放弃吧，我突然发现现在点击项目会出现一个多余重复的侧边栏， 什么时候被你改出来的， 

> 点开项目详情的动画又连同左边的侧边栏一起动了，你别拆东墙补西墙，我之前提过的要求你别给我忘了，做不到就直说，别来回改， 

> 你又给我改回去了， 现在点开项目又出现了两个侧边栏， 我说了，你别两个错误代码来回改，

> 你还在来回改，我都说了，这种方案会导致点开项目整个页面包括侧边栏都动了， 你到底懂不懂， 两个要求能不能兼顾，做不到就直说，不要在两种错误的方案来回改，

> 还要“您觉得”，两个侧边栏和动画问题你觉得哪个问题严重还要问我？

> 现在回到最开始的需求，你有做到吗， 响应式布局，根据宽度，手机，平板，桌面，三种布局，你实现了吗？仔细检查一下，

> 错误要处理好， The constructor being called isn't a const constructor.

> 你在干什么， 瞎改了一堆代码报错代码根本没改到， lib/features/detail/detail_page.dart:53，
而且还说AdaptiveNavigation不能是const，_navigationStore改成getter不行吗，项目里一堆的这种代码都是你写的你不知道吗？
另外我刚发现一堆控件都被你写成了StatefulWidget,我都用mobx了，真的需要这么多stateful吗？你给我全部检查一下， 

> 瞎改什么，怎么连国际化资源名都给你改了， 这修改和我提的要求有关系吗？改的时候你检查过国际化资源吗？里面有你改出来的字符串吗，好好检查别乱改代码，

> 我说的是登录页啊大哥，你改了什么你自己都不知道吗？

> 你还偷偷把详情页的测试数据改成了英文， 这种修改有意义吗？

> 1. 可折叠的侧边栏在点击其中的标签时没有自动折叠侧边栏，
2. 说好的三级，在哪里？现有代码都是你写的垃圾代码，该改的都可以该，要大改，你现在完全没有实现我一开始的需求， 还记得我的需求吗， 

> 等等，你完全记错了我的需求， 你看看README，写的清清楚楚还是你自己写的，响应式布局，

> 你改完了？就改这几行？差多少你知道吗？代码还有一大堆报错，你完全没管？我这么复杂的需求你打算改这几行？你给我仔细看看所有代码啊，全都可以重写，

> main报错了，改漏了？我都说了全部检查重写了， 莫名奇妙的把变量改名了然后引用的位置又不改，你是想干嘛？

上一句AI已经不回答了， 大概是上下文太长了， 放弃前一次ai的修改， 这个项目就先到这了， 
